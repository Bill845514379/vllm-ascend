...
from vllm_ascend.models.minimax_m3.ops.msa_m3 import (
...
@patch("vllm_ascend.models.minimax_m3.ops.msa_m3.get_current_vllm_config")
...
@patch("vllm_ascend.models.minimax_m3.ops.msa_m3.get_forward_context")
...
@patch("vllm_ascend.models.minimax_m3.modeling.logger.warning")
@patch("vllm_ascend.models.minimax_m3.modeling.AscendMiniMaxM3Indexer")
@patch("vllm_ascend.models.minimax_m3.modeling.AscendMiniMaxM3IndexerLinear")
@patch("vllm_ascend.models.minimax_m3.modeling.AscendMiniMaxM3SparseImpl")
@patch("vllm_ascend.models.minimax_m3.modeling.kv_cache_dtype_str_to_dtype")
@patch("vllm_ascend.models.minimax_m3.modeling.get_current_vllm_config")
@patch("vllm_ascend.models.minimax_m3.modeling.GemmaRMSNorm")
@patch("vllm_ascend.models.minimax_m3.modeling.get_rope")
@patch("vllm_ascend.models.minimax_m3.modeling.RowParallelLinear")
@patch("vllm_ascend.models.minimax_m3.modeling.QKVParallelLinear")
@patch("vllm_ascend.models.minimax_m3.modeling.AscendMiniMaxM3QKVParallelLinearWithIndexer")
@patch("vllm_ascend.models.minimax_m3.modeling.get_tensor_model_parallel_world_size", return_value=1)
...
@patch("vllm_ascend.models.minimax_m3.ops.msa_m3.minimax_m3_sparse_attn")
@patch("vllm_ascend.models.minimax_m3.ops.msa_m3.minimax_m3_sparse_attn_decode")
@patch("vllm_ascend.models.minimax_m3.ops.msa_m3.get_forward_context")
