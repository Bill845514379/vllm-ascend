...
def _handle_forced_tool_choice_none_content(request, content: str | None):
...
if hasattr(OpenAIServing, "_parse_tool_calls_from_content"):
    ...
    def _patched_parse_tool_calls_from_content(
        ...
        handled = _handle_forced_tool_choice_none_content(request, content)
...
def _patched_extract_tool_calls(
    ...
    return _original_extract_tool_calls(
        self,
        content,
        request,
        enable_auto_tools,
...
DelegatingParser._extract_tool_calls = _patched_extract_tool_calls
